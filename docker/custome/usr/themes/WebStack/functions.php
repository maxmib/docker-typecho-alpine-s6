...
<hr>
   ...
   <p class="previous-tab"><strong><svg  class="icon zmki_aliico" aria-hidden="true"><use xlink:href="#icon-chicken"></use></svg> 主题版本号: </strong>1.11.1 <span></span></p>
<hr>
...
<input type="submit" name="type" class="btn btn-s" value="备份模板设置数据" />&nbsp;&nbsp;<input type="submit" name="type" class="btn btn-s" value="还原模板设置数据" />&nbsp;&nbsp;<input type="submit" name="type" class="btn btn-s" value="删除备份数据" /></form><br>';
 ...
 <div class="zmki_ht_about_img"><a href="https://jq.qq.com/?_wv=1027&k=z8DfLjVj" target="_blank"><img src="/usr/themes/WebStack/images/jq.png" width="80%" "/></a>
...
<span>  V1.11.1 已去除主题设置里画蛇添足的 自定义站点名称和后缀功能，如设置直接移步至</span>';
?>   
